      ...
      <form className="mt-4 grid grid-cols-4 gap-4">
        ...
        >
          <div className="flex justify-between py-4">
            ...
            <p className="text-gray-400">Product coupons</p>
          </div>
          <hr />
          <div>
          ...
          <div className="mt-4">
            <div className="form-control flex flex-row gap-4 items-center">
              <input
                ...
                type="radio"
                defaultChecked={couponData.eligiblityTitle}
                value="all_customers"
              />
        ...
        <motion.div
          ...
          animate="animate"
          variants={fadeInFromLeftVariant}
          className="col-span-4 md:col-span-3 border-[1px] border-base-300 p-4 bg-base-100 rounded-xl"
        >
          ...
          <div className="py-4 grid grid-cols-2 mt-5">
            <div className="join col-span-1 ">
              <input
                ...
                type="radio"
                name="typeTitle"
                defaultChecked={couponData.typeTitle}
                value="fixed_value"
            ...
            <div className="form-control col-span-1 w-full">
              <label className="input-group">
                <input
                  onChange={(e) => handleInputChange(e)}
                  name="typeValue"
                  defaultValue={couponData.typeValue}
                  placeholder="0.01"
          ...
          <div className="mt-4">
            <div className="form-control flex flex-row gap-4 items-center">
              <input
                ...
                defaultChecked={couponData.requirementTitle}
          ...
          <div className="mt-4">
            <div className="form-control flex flex-row gap-4 items-center">
              <input
                ...
                className="radio radio-primary"
                type="radio"
                defaultChecked={couponData.collectionId}
            ...
            <div className="form-control flex flex-row gap-4 items-center">
              <input
                ...
                className="radio radio-primary"
                type="radio"
                defaultChecked={couponData.productId}
                name="specifyCollection"
            ...
            <div className="form-control flex flex-row gap-4 items-center">
              <input
                ...
                className="radio radio-primary"
                type="radio"
                defaultChecked={couponData.categoryId}
                name="specifyCollection"
        ...
        <motion.div
          ...
          animate="animate"
          variants={fadeInFromLeftVariant}
          className="col-span-4 md:col-span-3 p-4 bg-base-100 rounded-xl border-base-300 border-[1px]"
        >
