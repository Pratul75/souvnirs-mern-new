...
import { caroselMapppingDailyDealsShowDynamic } from "../../../mappings";
  ...
  return (
    <ScrollAnimationWrapper>
      <div className="flex flex-col justify-between h-full border-2 border-shopPrimaryColor">
        <div className="bg-shopPrimaryColor text-white py-4  px-2  border-shopPrimaryColor flex justify-between">
          <h1>Daily Deals</h1>
